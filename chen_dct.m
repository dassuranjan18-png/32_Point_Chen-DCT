...
dctII = zeros(32, numRuns); % 32x5 matrix to store all runs
...
dctII = zeros(1,32,'single');




dctII(0+1, runIdx)  = F_stage5(0+1)  * 0.1767767;
dctII(1+1, runIdx)  = F_stage8(16+1) * 0.25;
dctII(2+1, runIdx)  = F_stage7(8+1)  * 0.25;
dctII(3+1, runIdx)  = F_stage8(24+1) * 0.25;
dctII(4+1, runIdx)  = F_stage6(4+1)  * 0.25;
dctII(5+1, runIdx)  = F_stage8(20+1) * 0.25;
dctII(6+1, runIdx)  = F_stage7(12+1) * 0.25;
dctII(7+1, runIdx)  = F_stage8(28+1) * 0.25;
dctII(8+1, runIdx)  = F_stage5(2+1)  * 0.25;
dctII(9+1, runIdx)  = F_stage8(18+1) * 0.25;
dctII(10+1, runIdx) = F_stage7(10+1) * 0.25;
dctII(11+1, runIdx) = F_stage8(26+1) * 0.25;
dctII(12+1, runIdx) = F_stage6(6+1)  * 0.25;
dctII(13+1, runIdx) = F_stage8(22+1) * 0.25;
dctII(14+1, runIdx) = F_stage7(14+1) * 0.25;
dctII(15+1, runIdx) = F_stage8(30+1) * 0.25;
dctII(16+1, runIdx) = F_stage5(1+1)  * 0.25;
dctII(17+1, runIdx) = F_stage8(17+1) * 0.25;
dctII(18+1, runIdx) = F_stage7(9+1)  * 0.25;
dctII(19+1, runIdx) = F_stage8(25+1) * 0.25;
dctII(20+1, runIdx) = F_stage6(5+1)  * 0.25;
dctII(21+1, runIdx) = F_stage8(21+1) * 0.25;
dctII(22+1, runIdx) = F_stage7(13+1) * 0.25;
dctII(23+1, runIdx) = F_stage8(29+1) * 0.25;
dctII(24+1, runIdx) = F_stage5(3+1)  * 0.25;
dctII(25+1, runIdx) = F_stage8(19+1) * 0.25;
dctII(26+1, runIdx) = F_stage7(11+1) * 0.25;
dctII(27+1, runIdx) = F_stage8(27+1) * 0.25;
dctII(28+1, runIdx) = F_stage6(7+1)  * 0.25;
dctII(29+1, runIdx) = F_stage8(23+1) * 0.25;
dctII(30+1, runIdx) = F_stage7(15+1) * 0.25;
dctII(31+1, runIdx) = F_stage8(31+1) * 0.25;



Feature1 = dctII(:);
save('chen_dct.mat', 'dctII');
